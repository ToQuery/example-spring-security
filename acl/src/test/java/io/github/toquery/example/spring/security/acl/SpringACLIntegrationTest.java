...
import io.github.toquery.example.spring.security.acl.persistence.dao.NoticeMessageRepository;
import io.github.toquery.example.spring.security.acl.persistence.entity.NoticeMessage;
...
public class SpringACLIntegrationTest extends AbstractJUnit4SpringContextTests{
    ...
    @Configuration
    @ComponentScan("io.github.toquery.example.spring.security.acl.*")
